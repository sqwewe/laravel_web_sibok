  ...
  <div>
    <nav class="navbar text-bg-primary p-3 ">
      <div class="container-fluid">
        <a class="navbar-brand text-white" href="/arhiv">Изменение данных о ребёнке</a>
    ...
    <div class="container-fluid my-5 mx-5">
      <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <form action="{{route('arhiv.update-Child', $data->id)}}" method="post">
              @csrf
              <!-- @method('patch') -->
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="execution" class="form-control" id="execution"  value="{{$data->execution}}"></input>
              </div>
              <div class="mb-3">
                <label for="category" class="form-label">Категория</label>
                <input type="text" name="category" class="form-control" id="category"  value="{{$data->category}}"></input>
              </div>
